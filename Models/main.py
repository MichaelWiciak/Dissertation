...
def loadData():
    ...
    train_data = mw.openFile("../DatasetManipulations/preprocessed/train/train_code.jsonl")
    # load the validation data
    valid_data = mw.openFile("../DatasetManipulations/preprocessed/valid/valid_code.jsonl")
    # load the test data
